...
Let $b$ be ... and $\widehat{\bm b}$ its predictions. For full rank matrix $W \in R^{q \times s}$, where $ s \le q$, the fraction of confounding in the $s$-dimensional space spanned by $W$ is defined as 
\begin{equation}\label{eq:fc2}
