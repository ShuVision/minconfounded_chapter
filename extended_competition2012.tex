...
\end{align}
%
where $\bm{P} = \bm{V}\inv( \bm{I} - \bm{X} (\bm{X}\trans \bm{V}\inv \bm{X})\inv \bm{X}\trans \bm{V}\inv)$ \al{and $\bm{V} = \bm{ZDZ}\trans + \bm{R}$}. This  set of equations %\eqref{eq:resid1} and \eqref{eq:resid2} 
