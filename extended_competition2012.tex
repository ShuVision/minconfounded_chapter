...
\todo[inline]{The below paragraph might fit better at the end of this section (as per discussion 4/24)}
\al{
...
\todo[inline]{A paragraph motivating the varimax rotation is needed (see below). A picture showing examples of this would help (4/24).}
...
\todo[inline]{Add a few levels of $s$ into the mix here}
