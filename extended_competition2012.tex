...
\todo[inline]{Add a comment about these Q-Q plots being representative for situations when the level-1 assumptions are violated -- Where does this best fit?}
...
\subfloat[Random intercept]{
	...
	& \multicolumn{3}{c}{Test} \\ \cline{2-4}
	  	&     AD & CVM  & KS \\ \hline
	Normal       	   &	 0.847 & 0.821 & 0.710  \\ 
	Heavy tailed 	   & 0.655 & 0.612 & 0.471  \\ 
	Skewed       	   & 0.910 & 0.903 & 0.802  \\  
	\hline
	\end{tabular}
}
\qquad
\subfloat[Random slope]{
	...
	& \multicolumn{3}{c}{Test} \\ \cline{2-4}
	  	&     AD & CVM  & KS \\ \hline
	Normal       	  & 	0.888 & 0.866 & 0.792  \\ 
	Heavy tailed 	  &	0.739 & 0.712 & 0.591  \\ 
	Skewed       	  &	0.939 & 0.938 & 0.869  \\  
	\hline
	\end{tabular}
}
\end{table}
...
%; however, we used only a the subset of the 60 counties with full rank $\bm{Z}$ matrices for simplicity of the simulation design.
