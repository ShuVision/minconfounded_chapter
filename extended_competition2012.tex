...
%Further investigation  reveals  that a  proportion far above the nominal $\alpha=0.05$ level of random intercepts also fail the normality tests. 
...
%<<<<<<< HEAD
%%Table~\ref{tab:edf} shows results from 
