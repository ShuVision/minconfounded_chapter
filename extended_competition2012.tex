...
\al{ \citet{Verbeke:1996va} have shown that the empirical Bayes estimates of the random effects can be severely distorted if the true distribution is not normal; thus, this distributional assumption must be checked carefully when the random effects are central to the inferential goals.}
