...
\begin{figure}[t]
	\centering
	\subfloat[$\bm{W}^{*\prime}$]{
		\includegraphics[width=0.49\textwidth]{cropped_cartoon_heatmap_raw.pdf}
	}
	\subfloat[$\bm{Q}\trans\bm{W}^{*\prime}$]{
		\includegraphics[width=0.49\textwidth]{cropped_cartoon_heatmap_varimax.pdf}
	}
...
\todo[inline]{Should we use the full rank matrices or not? The only thing this does is ``clean up'' the simulations with $s$}
