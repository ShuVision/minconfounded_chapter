...
%\todo[inline]{Combine this paragraph and the above}
...
%\begin{table}[h]
%\centering
%\caption{\label{tab:edf} Proportions of tests rejecting the null hypothesis of normality of the predicted random effects at the nominal .05 significance level when the errors are normal, heavy tailed, and skewed. The type I error rates are hugely inflated under each setting. \vspace{.5em}}
