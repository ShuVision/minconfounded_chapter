...
\subsection{Lineup details}
As an alternative to the standard Q-Q plot, a detrended version of Q-Q plots (see figure~\ref{fig:lineup-2}) was shown to participants in a study. In the detrended Q-Q plot, the plot is rotated by 45$^\degree$ to make comparisons between the line of identity and the empirical distribution function cognitively easier. XXX
\begin{figure}[htb]
	\centering
	\includegraphics[width=0.9\textwidth]{qq-lineup-rot.pdf}%test.jpeg}%lineup-rslope.pdf}
	\caption{\label{fig:lineup-2} Lineup of detrended Q-Q plots for the random slope term in model~\eqref{eq:radon}. This plot shows the exact same data as the standard Q-Q plots of figure~\ref{fig:lineup}. Out of 15 evaluations, 9 participants picked panel \#(3^2+3)$ as the most different from the set; another 4 participants decided for panel \#$(2 \cdot 3^2)$. None of the participant picked the panel of the observed data.}
\end{figure}
