...
\todo[inline]{The below paragraph was moved to the end of this section (as per discussion 4/24) -- need to work on the transition after the section has been written.}
...
Under each simulation setting 1000 data sets were generated for each model and the rotated residuals were obtained using $s = \rank(\bm{B})$. We additionally explored $s =$ 80, 70, 60, 50, and 40 for the random intercept and $s = $ 50 and 40 for the random slope.\todo{Change this once the simulations have been run}
