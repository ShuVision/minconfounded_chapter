...
\begin{tabular}{ll p{.1cm} c p{.1cm} rrr p{.1cm} rrr p{.1cm} rrr}
  ...
  Random effects & Errors & & $\alpha$ & & AD & CVM & KS & & AD & CVM & KS & & AD & CVM & KS \\ 
   \hline
& && && \multicolumn{9}{c}{$\sigma_{\varepsilon}^2 = 4$, \ \ $\sigma_{b_0}^2 = \sigma_{b_1}^2 = 1$} \\ \cline{6-16}
Normal       & Normal       && 0.05 &&  0.05 & 0.05 & 0.06 && 0.05 & 0.05 & 0.05 && 0.05 & 0.05 & 0.05 \\ 
             &              && 0.10 &&  0.09 & 0.10 & 0.11 && 0.10 & 0.10 & 0.09 && 0.10 & 0.10 & 0.09 \\ 
             & Heavy tailed && 0.05 &&  0.09 & 0.08 & 0.08 && 0.09 & 0.09 & 0.08 && 0.09 & 0.09 & 0.08 \\ 
             &              && 0.10 &&  0.14 & 0.13 & 0.13 && 0.15 & 0.13 & 0.14 && 0.15 & 0.13 & 0.14 \\ 
             & Skewed       && 0.05 &&  0.06 & 0.05 & 0.04 && 0.07 & 0.06 & 0.07 && 0.07 & 0.06 & 0.07 \\ 
             &              && 0.10 &&  0.10 & 0.10 & 0.10 && 0.13 & 0.12 & 0.12 && 0.13 & 0.12 & 0.12 \\ 
             &&&&&&&&&&&&&&&\\
...
\begin{tabular}{ll p{.1cm} c p{.1cm} rrr p{.1cm} rrr p{.1cm} rrr}
  ...
  Random effects & Errors & & $\alpha$ & & AD & CVM & KS & & AD & CVM & KS & & AD & CVM & KS \\ 
   \hline
& && && \multicolumn{9}{c}{$\sigma_{\varepsilon}^2 = 4$, \ \ $\sigma_{b_0}^2 = \sigma_{b_1}^2 = 1$} \\ \cline{6-16}
Normal       & Normal       && 0.05 &&   0.04 & 0.04 & 0.05 && 0.05 & 0.04 & 0.04 && 0.05 & 0.04 & 0.04 \\ 
             &              && 0.10 &&   0.09 & 0.10 & 0.10 && 0.11 & 0.11 & 0.11 && 0.11 & 0.11 & 0.11 \\ 
             & Heavy tailed && 0.05 &&   0.15 & 0.14 & 0.13 && 0.17 & 0.15 & 0.13 && 0.17 & 0.15 & 0.13 \\ 
             &              && 0.10 &&   0.21 & 0.20 & 0.18 && 0.24 & 0.23 & 0.21 && 0.24 & 0.23 & 0.21 \\ 
             & Skewed       && 0.05 &&   0.10 & 0.10 & 0.08 && 0.10 & 0.10 & 0.10 && 0.10 & 0.10 & 0.10 \\ 
             &              && 0.10 &&   0.16 & 0.16 & 0.15 && 0.18 & 0.18 & 0.17 && 0.18 & 0.18 & 0.17 \\ 
             &&&&&&&&&&&&&&&\\
...
\begin{tabular}{ll p{.1cm} c p{.1cm} rrr p{.1cm} rrr p{.1cm} rrr}
  ...
  Random effects & Errors & & $\alpha$ & & AD & CVM & KS & & AD & CVM & KS & & AD & CVM & KS \\ 
   \hline
& && && \multicolumn{9}{c}{$\sigma_{\varepsilon}^2 = 4$, \ \ $\sigma_{b_0}^2 = \sigma_{b_1}^2 = 1$} \\ \cline{6-16}
\rowcolor{gray!20}Normal       & Normal       && 0.05 &&   0.05 & 0.05 & 0.05 && 0.07 & 0.06 & 0.05 && 0.07 & 0.06 & 0.05 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.10 & 0.09 & 0.10 && 0.14 & 0.13 & 0.12 && 0.14 & 0.13 & 0.12 \\ 
\rowcolor{gray!20}             & Heavy tailed && 0.05 &&   0.09 & 0.08 & 0.08 && 0.12 & 0.11 & 0.09 && 0.12 & 0.11 & 0.09 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.15 & 0.14 & 0.14 && 0.21 & 0.19 & 0.17 && 0.21 & 0.19 & 0.17 \\ 
\rowcolor{gray!20}             & Skewed       && 0.05 &&   0.07 & 0.07 & 0.07 && 0.09 & 0.09 & 0.09 && 0.09 & 0.09 & 0.09 \\ 
...
\begin{tabular}{ll p{.1cm} c p{.1cm} rrr p{.1cm} rrr p{.1cm} rrr}
  ...
  Random effects & Errors & & $\alpha$ & & AD & CVM & KS & & AD & CVM & KS & & AD & CVM & KS \\ 
   \hline
& && && \multicolumn{9}{c}{$\sigma_{\varepsilon}^2 = 4$, \ \ $\sigma_{b_0}^2 = \sigma_{b_1}^2 = 1$} \\ \cline{6-16}
\rowcolor{gray!20}Normal       & Normal       && 0.05 &&   0.05 & 0.05 & 0.04 && 0.08 & 0.07 & 0.08 && 0.08 & 0.07 & 0.08 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.09 & 0.10 & 0.10 && 0.14 & 0.13 & 0.13 && 0.14 & 0.13 & 0.13 \\ 
\rowcolor{gray!20}             & Heavy tailed && 0.05 &&   0.12 & 0.11 & 0.10 && 0.18 & 0.15 & 0.13 && 0.18 & 0.15 & 0.13 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.19 & 0.18 & 0.17 && 0.27 & 0.23 & 0.20 && 0.27 & 0.23 & 0.20 \\ 
\rowcolor{gray!20}             & Skewed       && 0.05 &&   0.07 & 0.07 & 0.06 && 0.11 & 0.10 & 0.10 && 0.11 & 0.10 & 0.10 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.14 & 0.14 & 0.13 && 0.20 & 0.18 & 0.18 && 0.20 & 0.18 & 0.18 \\ 
             &&&&&&&&&&&&&&&\\
Heavy tailed & Normal       && 0.05 &&   0.30 & 0.26 & 0.21 && 0.41 & 0.36 & 0.28 && 0.41 & 0.36 & 0.28 \\ 
             &              && 0.10 &&   0.38 & 0.35 & 0.31 && 0.51 & 0.45 & 0.38 && 0.51 & 0.45 & 0.38 \\ 
             & Heavy tailed && 0.05 &&   0.45 & 0.40 & 0.33 && 0.55 & 0.51 & 0.42 && 0.55 & 0.51 & 0.42 \\ 
...
\begin{tabular}{ll p{.1cm} c p{.1cm} rrr p{.1cm} rrr p{.1cm} rrr}
  ...
  Random effects & Errors & & $\alpha$ & & AD & CVM & KS & & AD & CVM & KS & & AD & CVM & KS \\ 
   \hline
& && && \multicolumn{9}{c}{$\sigma_{\varepsilon}^2 = 4$, \ \ $\sigma_{b_0}^2 = \sigma_{b_1}^2 = 1$} \\ \cline{6-16}
\rowcolor{gray!20}Normal       & Normal       && 0.05 &&   0.06 & 0.06 & 0.05 && 0.12 & 0.12 & 0.08 && 0.12 & 0.12 & 0.08 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.11 & 0.11 & 0.11 && 0.20 & 0.20 & 0.17 && 0.20 & 0.20 & 0.17 \\ 
\rowcolor{gray!20}             & Heavy tailed && 0.05 &&   0.13 & 0.12 & 0.09 && 0.25 & 0.23 & 0.19 && 0.25 & 0.23 & 0.19 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.19 & 0.18 & 0.16 && 0.33 & 0.32 & 0.28 && 0.33 & 0.32 & 0.28 \\ 
\rowcolor{gray!20}             & Skewed       && 0.05 &&   0.08 & 0.07 & 0.07 && 0.15 & 0.14 & 0.12 && 0.15 & 0.14 & 0.12 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.14 & 0.13 & 0.11 && 0.23 & 0.20 & 0.21 && 0.23 & 0.20 & 0.21 \\ 
             &&&&&&&&&&&&&&&\\
Heavy tailed & Normal       && 0.05 &&   0.29 & 0.25 & 0.19 && 0.49 & 0.45 & 0.34 && 0.49 & 0.45 & 0.34 \\ 
             &              && 0.10 &&   0.37 & 0.34 & 0.29 && 0.61 & 0.56 & 0.47 && 0.61 & 0.56 & 0.47 \\ 
             & Heavy tailed && 0.05 &&   0.52 & 0.47 & 0.38 && 0.72 & 0.69 & 0.56 && 0.72 & 0.69 & 0.56 \\ 
...
\begin{tabular}{ll p{.1cm} c p{.1cm} rrr p{.1cm} rrr p{.1cm} rrr}
  ...
  Random effects & Errors & & $\alpha$ & & AD & CVM & KS & & AD & CVM & KS & & AD & CVM & KS \\ 
   \hline
& && && \multicolumn{9}{c}{$\sigma_{\varepsilon}^2 = 4$, \ \ $\sigma_{b_0}^2 = \sigma_{b_1}^2 = 1$} \\ \cline{6-16}
\rowcolor{gray!20}Normal       & Normal       && 0.05 &&   0.05 & 0.05 & 0.06 && 0.05 & 0.04 & 0.04 && 0.05 & 0.04 & 0.04 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.10 & 0.09 & 0.10 && 0.10 & 0.10 & 0.09 && 0.10 & 0.10 & 0.09 \\ 
\rowcolor{gray!20}             & Heavy tailed && 0.05 &&   0.09 & 0.09 & 0.08 && 0.10 & 0.08 & 0.08 && 0.10 & 0.08 & 0.08 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.16 & 0.15 & 0.14 && 0.17 & 0.16 & 0.14 && 0.17 & 0.16 & 0.14 \\ 
\rowcolor{gray!20}             & Skewed       && 0.05 &&   0.07 & 0.07 & 0.07 && 0.06 & 0.06 & 0.07 && 0.06 & 0.06 & 0.07 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.15 & 0.13 & 0.13 && 0.13 & 0.14 & 0.13 && 0.13 & 0.14 & 0.13 \\ 
             &&&&&&&&&&&&&&&\\
Heavy tailed & Normal       && 0.05 &&   0.16 & 0.16 & 0.12 && 0.19 & 0.17 & 0.14 && 0.19 & 0.17 & 0.14 \\ 
             &              && 0.10 &&   0.24 & 0.21 & 0.19 && 0.29 & 0.27 & 0.23 && 0.29 & 0.27 & 0.23 \\ 
...
\begin{tabular}{ll p{.1cm} c p{.1cm} rrr p{.1cm} rrr p{.1cm} rrr}
  ...
  Random effects & Errors & & $\alpha$ & & AD & CVM & KS & & AD & CVM & KS & & AD & CVM & KS \\ 
   \hline
& && && \multicolumn{9}{c}{$\sigma_{\varepsilon}^2 = 4$, \ \ $\sigma_{b_0}^2 = \sigma_{b_1}^2 = 1$} \\ \cline{6-16}
\rowcolor{gray!20}Normal       & Normal       && 0.05 &&   0.05 & 0.05 & 0.04 && 0.05 & 0.06 & 0.06 && 0.05 & 0.06 & 0.06 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.09 & 0.10 & 0.10 && 0.10 & 0.11 & 0.11 && 0.10 & 0.11 & 0.11 \\ 
\rowcolor{gray!20}             & Heavy tailed && 0.05 &&   0.13 & 0.11 & 0.10 && 0.13 & 0.12 & 0.12 && 0.13 & 0.12 & 0.12 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.19 & 0.18 & 0.16 && 0.22 & 0.20 & 0.17 && 0.22 & 0.20 & 0.17 \\ 
\rowcolor{gray!20}             & Skewed       && 0.05 &&   0.07 & 0.07 & 0.06 && 0.08 & 0.07 & 0.08 && 0.08 & 0.07 & 0.08 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.14 & 0.14 & 0.13 && 0.14 & 0.15 & 0.14 && 0.14 & 0.15 & 0.14 \\ 
             &&&&&&&&&&&&&&&\\
Heavy tailed & Normal       && 0.05 &&   0.30 & 0.27 & 0.21 && 0.36 & 0.32 & 0.25 && 0.36 & 0.32 & 0.25 \\ 
             &              && 0.10 &&   0.39 & 0.35 & 0.31 && 0.45 & 0.42 & 0.34 && 0.45 & 0.42 & 0.34 \\ 
             & Heavy tailed && 0.05 &&   0.45 & 0.41 & 0.33 && 0.51 & 0.47 & 0.39 && 0.51 & 0.47 & 0.39 \\ 
...
\begin{tabular}{ll p{.1cm} c p{.1cm} rrr p{.1cm} rrr p{.1cm} rrr}
  ...
  Random effects & Errors & & $\alpha$ & & AD & CVM & KS & & AD & CVM & KS & & AD & CVM & KS \\ 
   \hline
& && && \multicolumn{9}{c}{$\sigma_{\varepsilon}^2 = 4$, \ \ $\sigma_{b_0}^2 = \sigma_{b_1}^2 = 1$} \\ \cline{6-16}
\rowcolor{gray!20}Normal       & Normal       && 0.05 &&   0.06 & 0.05 & 0.05 && 0.06 & 0.06 & 0.05 && 0.06 & 0.06 & 0.05 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.09 & 0.10 & 0.11 && 0.10 & 0.09 & 0.10 && 0.10 & 0.09 & 0.10 \\ 
\rowcolor{gray!20}             & Heavy tailed && 0.05 &&   0.11 & 0.10 & 0.10 && 0.12 & 0.11 & 0.10 && 0.12 & 0.11 & 0.10 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.17 & 0.17 & 0.15 && 0.19 & 0.18 & 0.16 && 0.19 & 0.18 & 0.16 \\ 
\rowcolor{gray!20}             & Skewed       && 0.05 &&   0.07 & 0.06 & 0.06 && 0.06 & 0.06 & 0.07 && 0.06 & 0.06 & 0.07 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.12 & 0.12 & 0.13 && 0.13 & 0.12 & 0.12 && 0.13 & 0.12 & 0.12 \\ 
             &&&&&&&&&&&&&&&\\
Heavy tailed & Normal       && 0.05 &&   0.18 & 0.16 & 0.14 && 0.24 & 0.22 & 0.17 && 0.24 & 0.22 & 0.17 \\ 
             &              && 0.10 &&   0.26 & 0.23 & 0.21 && 0.34 & 0.31 & 0.26 && 0.34 & 0.31 & 0.26 \\ 
             & Heavy tailed && 0.05 &&   0.30 & 0.27 & 0.21 && 0.34 & 0.31 & 0.25 && 0.34 & 0.31 & 0.25 \\ 
...
\begin{tabular}{ll p{.1cm} c p{.1cm} rrr p{.1cm} rrr p{.1cm} rrr}
  ...
  Random effects & Errors & & $\alpha$ & & AD & CVM & KS & & AD & CVM & KS & & AD & CVM & KS \\ 
   \hline
& && && \multicolumn{9}{c}{$\sigma_{\varepsilon}^2 = 4$, \ \ $\sigma_{b_0}^2 = \sigma_{b_1}^2 = 1$} \\ \cline{6-16}
\rowcolor{gray!20}Normal       & Normal       && 0.05 &&   0.06 & 0.05 & 0.04 && 0.05 & 0.04 & 0.04 && 0.05 & 0.04 & 0.04 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.10 & 0.10 & 0.11 && 0.10 & 0.10 & 0.09 && 0.10 & 0.10 & 0.09 \\ 
\rowcolor{gray!20}             & Heavy tailed && 0.05 &&   0.13 & 0.11 & 0.08 && 0.15 & 0.14 & 0.13 && 0.15 & 0.14 & 0.13 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.19 & 0.18 & 0.15 && 0.23 & 0.22 & 0.20 && 0.23 & 0.22 & 0.20 \\ 
\rowcolor{gray!20}             & Skewed       && 0.05 &&   0.08 & 0.07 & 0.06 && 0.07 & 0.07 & 0.07 && 0.07 & 0.07 & 0.07 \\ 
\rowcolor{gray!20}             &              && 0.10 &&   0.14 & 0.12 & 0.10 && 0.13 & 0.13 & 0.13 && 0.13 & 0.13 & 0.13 \\ 
             &&&&&&&&&&&&&&&\\
Heavy tailed & Normal       && 0.05 &&   0.28 & 0.25 & 0.18 && 0.36 & 0.33 & 0.27 && 0.36 & 0.33 & 0.27 \\ 
             &              && 0.10 &&   0.37 & 0.33 & 0.27 && 0.47 & 0.42 & 0.35 && 0.47 & 0.42 & 0.35 \\ 
