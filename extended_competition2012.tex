...
There are many ways of defining a fraction of confounding using different symmetric functions of the relative eigenvalues of $\bm{WAW}\trans$ to $\bm{WBW}\trans$. Here, we choose the trace of the ratio to generalize the results in \cite{HildenMinton:1995wh}.%, but other symmetric functions could be investigated. 
...
The inverse function of the ratio of the traces (called the ``trace ratio'' problem) on the other hand, does not have a  closed form solution to the analog of the optimization problem we discuss below \citep[cf.,][]{Jia:2009ux}. 
